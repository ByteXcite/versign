...
if [ `ls ../jpg_to_mnist/test-images/*/*.jpg 2> /dev/null | wc -l ` -gt 0 ]; then
  echo hi
...
if [ `ls ../jpg_to_mnist/test-images/*/*.png 2> /dev/null | wc -l ` -gt 0 ]; then
  echo hi
...
if [ `ls ../jpg_to_mnist/training-images/*/*.jpg 2> /dev/null | wc -l ` -gt 0 ]; then
  echo hi
...
if [ `ls ../jpg_to_mnist/training-images/*/*.png 2> /dev/null | wc -l ` -gt 0 ]; then
  echo hi
